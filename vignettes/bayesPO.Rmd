...
```{r fit}
fit <- fit_bayesPO(model, bayesPO_sim$bkg, area = 1, mcmc_setup = list(burnin = 1000, iter = 2000))
```
...
>>>>>>> 4de4a54875ff2ec65fe9e868b4e9f5309e5420e2
fit2 <- fit_bayesPO(fit, bayesPO_sim$bkg, mcmc_setup = list(iter = 10000))
```
...
All true values are included in 95% credible intervals, which is good!
