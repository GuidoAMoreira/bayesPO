...
#'
#' This small dataset was simulated using the package's model, with the logit
...
#' \describe{
#' \item{po}{A matrix with 422 rows and 2 columns. The first column is the
...
#' \item{po_sightings}{A 591 long logical vector that identified the
